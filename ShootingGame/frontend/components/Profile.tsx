      ...
      <div className="parent">
        <div className="card">
          ...
          <div className="content">
            <span className="title">Hello {user?.name}</span>
            <div className="flex justify-around text-white text-2xl mx-2 mt-2">
          ...
          <div className="bottom">
            ...
            <Link
              ...
              href="http://192.168.18.146:3004"
            >
              <p>
                <button className="view-more-button">Start Game</button>
              </p>
            </Link>
            ;
          </div>
